  ...
  <div class="container-fluid">
    <div class="quick-actions_homepage">
      <ul class="quick-actions">
        ...
        <li class="bg_ly"> <a href="{{ url('/admin/view-category') }}"> <i class="icon-group"></i><span class="label label-success">{{$categories}}</span> Categories </a> </li>
        <li class="bg_ls"> <a href="{{ url('/admin/view-product') }}"> <i class="icon-inbox"></i><span class="label label-success">{{$products}}</span> Products </a> </li>
        <li class="bg_ls"> <a href="{{ url('/admin/view-banner') }}"> <i class="icon-film"></i><span class="label label-success">{{$banners}}</span> Banners </a> </li>
