...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="index.html" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="{{ url('/admin/view-product') }}">Products</a> <a href="#" class="current">Add Product Attributes</a> </div>
          ...
          <div class="widget-content nopadding">
            ...
            <table class="table table-bordered data-table">
              ...
              <tbody>
                ...
                <tr class="gradeX">
                 <td><input type="hidden" name="idAttr[]" value="{{$attribute->id}}">{{$i++}}</td>
                 <td>{{$attribute->sku}}</td>
                 ...
                 <td class="center">
                  <input type="submit" value="update" class="btn btn-primary btn-mini">
                   <a rel="{{$attribute->id}}" {{-- rel1="delete_product" --}} href="{{ url('/admin/delete-attribute/'. $attribute->id) }}" {{-- href="javascript:" --}} class="btn btn-danger btn-mini">Delete</a></td>
                  </tr>
                  @endforeach
                </tbody>
              </table>  
