...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="{{ url('/admin/view-product') }}" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="{{ url('/admin/view-category') }}">Categories</a> <a href="#" class="current">Edit Category</a> </div>
    <h1>Categories</h1>
  </div>
            ...
            <form class="form-horizontal" method="post" action="{{ url('/admin/edit-category/'.$categorydetails->id) }}" name="add_category" id="add_category" novalidate="novalidate">
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <select name ="parent_id" style="width:220px;">
                    ...
                    <option value="{{$val->id}}" @if($val->id == $categorydetails->parent_id)selected @endif>{{$val->category_name}}
                    </option>
                    @endforeach
                  </select>
                </div>
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  ...
                  @if($categorydetails->status=="1")checked 
                  @endif value="1">
                </div>
              </div>
