...
<link rel="apple-touch-icon-precomposed" sizes="72x72" href="{{asset('images/ifrontend_images/co/apple-touch-icon-72-precomposed.png')}}">
...
<body>
	...
	{{-- @include('layouts.frontLayout.404')
 --}}	
	@yield('contents')
