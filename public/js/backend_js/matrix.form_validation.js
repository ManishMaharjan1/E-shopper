...
//     var maxField = 10; //Input fields increment limitation
//     var addButton = $('.add_button'); //Add button selector
//     var wrapper = $('#color'); //Input field wrapper
//     var fieldHTML = '<div  id="color" style="margin-top:10px;"><input type="text" name="product_color[]"  id="product_color"/><a href="javascript:void(0);" class="remove_button" title="Remove field">Remove</a></div>'; //New input field html 
//     var x = 1; //Initial field counter is 1
//     //Once add button is clicked
//     $(addButton).click(function(){
//         //Check maximum number of input fields
